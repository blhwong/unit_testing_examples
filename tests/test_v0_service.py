...
from v0.main import generate_model_scores


@pytest.fixture
def start_training_mock(mocker):
    mock = Mock()
    mocker.patch("v0.main.start_training", mock)
    return mock
...
def train_mock(mocker):
    mock = Mock()
    mocker.patch("v0.main.train", mock)
    return mock
...
def upload_mock(mocker):
    mock = Mock()
    mocker.patch("v0.main.upload", mock)
    return mock
...
def complete_training_mock(mocker):
    mock = Mock()
    mocker.patch("v0.main.complete_training", mock)
    return mock
...
def post_message_mock(mocker):
    mock = Mock()
    mocker.patch("v0.main.post_message", mock)
    return mock
